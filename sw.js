...
const SHELL_ASSETS = [
  ...
  './progress-io.js', './offline-ui.js', './sources-ui.js', './best-practices-ui.js', './external-tasks-ui.js', './interview-practice-ui.js', './analytics-ui.js', './home-ui.js',
...
const DATA_ASSETS = [
  ...
  './tasks/study_tests.json', './tasks/senior_cases.json', './tasks/best_practices.json', './tasks/external_tasks.json', './tasks/question_sources.json', './tasks/interview_practice.json'
];
