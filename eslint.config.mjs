...
export default [
  ...
  },
  {
    ...
    files: [
      ...
      'sources-ui.js', 'best-practices-ui.js', 'catalog-ui.js', 'chapter-ui.js', 'router.js', 'external-tasks-ui.js', 'interview-practice-ui.js', 'study-curriculum-rules.js', 'question-quality.js'
    ],
    languageOptions: {
      ecmaVersion: 2023,
      sourceType: 'script',
