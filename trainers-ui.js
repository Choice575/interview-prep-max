(function(root, factory) {
  ...
  const TRAINERS = [
    ...
    {
      // Разбор инцидентов раньше открывался только кнопкой на главной, среди
      // девяти других: восемь сценариев было негде увидеть. Своя карточка в
      // хабе даёт им место и показывает, сколько уже разобрано.
      id: 'incidents', page: 'incidents', icon: '🚨', title: 'Разбор инцидентов',
      skill: 'Ставить диагноз по симптомам и выводу команд',
      task: 'Четыре фазы: триаж, диагностика, исправление, postmortem',
      group: 'Диагностика', topic: 'Kubernetes', progressKey: 'inc_prog', datasetKey: 'incidents'
    },
    {
